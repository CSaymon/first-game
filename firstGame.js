    ...
    obstaculos = {
        ...
        atualiza: function () {
            ...
            for (var i = 0, tam = this._obs.length; i < tam; i++) {
                ...
                if (bloco.x < obs.x + obs.larg && bloco.x + bloco.largura >= obs.x && bloco.y + bloco.altura >= chao.y - obs.alt) {
                    estadoAtual = estados.perdeu;
                }
                else if (obs.x == 0) {
                    bloco.score++;
                }
                else if (obs.x <= -obs.larg) {
        ...
        desenha: function () {
            for (var i = 0, tam = this._obs.length; i < tam; i++) {
                ...
                ctx.fillRect(obs.x, chao.y - obs.alt, obs.larg, obs.alt);
            }
        },
    };
...
function desenha() {
    ...
    if (estadoAtual == estados.jogar) {
        ...
        spriteRecord.desenha(largura / 2 - spriteRecord.largura / 2, perdeu.altura + spriteRecord.altura - 50);
